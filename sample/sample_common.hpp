...
void SetInputMatricesAsCSC(CSC<INDEXTYPE, VALUETYPE> &A_csc, CSC<INDEXTYPE, VALUETYPE> &B_csc, char **argv)
{
	bool binary = false;
	bool gen = false;
...
template <class INDEXTYPE, class VALUETYPE>
void SetInputMatricesAsCSR(CSR<INDEXTYPE, VALUETYPE> &A_csr, CSR<INDEXTYPE, VALUETYPE> &B_csr, char **argv)
{
